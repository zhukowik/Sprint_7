...
class TestCreateCourier:
    ...
    def test_successful_create_courier(self,generate_courier_data):
        new_courier = CourierMethods.create_new_courier(generate_courier_data[0])
    ...
    def test_cant_create_two_identical_couriers(self):
        new_courier = CourierMethods.create_new_courier(GeneratePayload.generate_courier_payload())
    ...
    def test_successful_response_create_courier(self,generate_courier_data):
        new_courier = CourierMethods.create_new_courier(generate_courier_data[0])
        assert 201 == new_courier[0].status_code
        assert {'ok': True} == new_courier[0].json()
